...
* MySQL – Writing and executing analytical SQL queries

* Power BI – Interactive dashboard creation

* Gamma AI – Presentation and report generation
...
3.Cleaned the data by handling missing values, duplicates, and inconsistent formats

4.Exported cleaned data and loaded it into a MySQL database

5.Wrote SQL queries to answer key business questions

6.Connected MySQL to Power BI and built an interactive dashboard

7.Created a business report summarizing insights
...
* The dashboard enables quick, data-driven decision-making.
...
* Highlighted top-performing products and customer groups
...
6.Open the Power BI file and refresh data connection
...
* PDF report and presentation generated using Gamma AI
